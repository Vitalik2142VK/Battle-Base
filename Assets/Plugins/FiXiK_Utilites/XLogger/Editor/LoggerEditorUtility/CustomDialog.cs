...
namespace FiXiK.CustomLogger.Editor
{
    public class CustomDialog : EditorWindow
    {
        ...
        private void DrawFirstButton()
        {
            if (GUILayout.Button(
                _buttonText,
                GUILayout.Width(_buttonSize.x),
                GUILayout.Height(_buttonSize.y)))
            {
                _onConfirm?.Invoke();
                Close();
            }
        ...
        private void DrawSecondButton()
        {
            if (GUILayout.Button(
                ...
                GUILayout.Width(_secondaryButtonSize.x),
                GUILayout.Height(_secondaryButtonSize.y)))
            {
